...
namespace RBS.Auth.Db.Migrations
{
    ...
    [Migration("20220611173500_RBSAuth-Add-verification-codes")]
    partial class RBSAuthAddverificationcodes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RBS.Auth.Db.Domain.UserVerificationCodes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RBS.Auth.Db.Domain.UserVerificationCodes", b =>
                {
                    b.HasOne("RBS.Auth.Db.Domain.UserCredential", "User")
                        .WithMany()
